...
<body class="bg-white dark:bg-black">
            <!--Font Family-->
{{--    <p class="font-sans">This Text uses Font Family</p>--}}
{{--    <p class="font-serif">This Text uses Font Family</p>--}}
{{--    <p class="font-mono">This Text uses Font Family</p>--}}
...
{{--    <p class="text-2xl">4x Extra Large</p>--}}
...
{{--            <button class="text-gray-700 bg-yellow-300 px-4 py-4 mt-4 ml-4 border-4 border-red-500 rounded-xl hover:bg-white hover:text-green-500">Click Me</button>--}}
            ...
            <!--Layout-->
{{--            <div class="container relative border border-red-400 mt-10 mx-auto rounded-lg ">--}}
...
{{--                    <button class=" absolute bottom-0 transform translate-y-10 bg-yellow-300 px-4 py-4 mt-4 ml-4 border-4 border-red-500 rounded-xl hover:bg-white hover:text-green-500 my-3">Click Me</button>--}}
{{--                </div>--}}
